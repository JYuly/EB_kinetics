...
for n in range(N):
    ...
    Add_cofactor(cofactor_data, "H1", 0.320)
    Add_cofactor(cofactor_data, "H2", 0.2)
    Add_cofactor(cofactor_data, "L1", -0.25)
    Add_cofactor(cofactor_data, "L2", -0.1)

    Add_connection(cofactor_data, "Red", "L1", 12.4)
    Add_connection(cofactor_data, "Red", "H1", 13.2) #Artificially increase distance since this is known to be slower (adjusted to match approx 50/sec turnover)
    Add_connection(cofactor_data, "H1", "H2", 10)
    Add_connection(cofactor_data, "L1", "L2", 12.3)
    ...
    Add_reservoir(cofactor_data, "H2", 1, "High potential reservoir", 0.00, 10**7)
