...
for n in range(N):
    ...
    Add_connection(cofactor_data, "Red", "L1", cofactor_distance*0.5)#this is a short-circuit (enhanced by shortening distance by 5 Angstrom to show robustness)
    ...
    Add_connection(cofactor_data, "SQ", "H1", cofactor_distance*0.5) #this is a short-circuit(enhanced by shortening distance by 5 Angstrom to show robustness)
