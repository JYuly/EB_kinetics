...
for n in range(N):
    ...
    Add_connection(cofactor_data, "Red", "H1", 13.7) #Artificially increase distance since this is known to be slower
    ...
    Add_reservoir(cofactor_data, "L2", 1, "Low potential reservoir", -0.040,10**7)  #-0.04 because quinone's midpoint potential is 90mV
